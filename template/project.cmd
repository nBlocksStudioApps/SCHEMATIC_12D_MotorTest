...
if exist replacer.exe          copy replacer.exe           ..\%1
if exist r.cmd                 copy r.cmd                  ..\%1
if exist PurchaseList.xlt*     copy PurchaseList.xlt*      ..\%1
rem if exist template1.pcbdoc      copy template1.pcbdoc   ..\%1
rem if exist template2.pcbdoc      copy template2.pcbdoc   ..\%1
rem if exist template3.pcbdoc      copy template3.pcbdoc   ..\%1
rem if exist template4.pcbdoc      copy template4.pcbdoc   ..\%1
rem if exist template1.schdoc      copy template1.schdoc   ..\%1
rem if exist template2.schdoc      copy template2.schdoc   ..\%1
rem if exist template3.schdoc      copy template3.schdoc   ..\%1
rem if exist template4.schdoc      copy template4.schdoc   ..\%1
