...
if exist .\asm\Pick_Place.csv replacer.exe  replace_template.txt .\asm\Pick_Place.csv .\asm\Pick_Place_UPDATED.csv -r
...
echo pcb assembly file set done at %v_datestamp%_%v_timestamp% > .\template\asm.txt